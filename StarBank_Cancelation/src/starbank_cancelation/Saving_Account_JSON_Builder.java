...
public class Saving_Account_JSON_Builder implements Account_Builder {
    
    private Saving_Account cuenta;
    private String data;
    
    public Saving_Account_JSON_Builder(String data) throws ParseException {
        
        this.cuenta = new Saving_Account();
        this.data = data;
